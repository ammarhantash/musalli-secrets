const en = {
  ...
  waitlist: {
    ...
    cityPlaceholder: 'City (e.g. Jeddah, Riyadh)',
    submit: 'Join the waitlist',
    submitting: 'Joining…',
    success: 'You\'re on the list. The next secret will find you first.',
    error: 'We couldn\'t add you just now. Check your connection and try again.',
  },
  about: {
  ...
  catalog: {
    ...
    emptyTitle: 'The Vault is being prepared.',
    emptyBody: 'The next secret hasn\'t dropped yet. Join the waitlist and we\'ll tell you the moment it does.',
    emptyCta: 'Join the waitlist →',
    sets: {
      set_alnur: {
  ...
  configurator: {
    ...
    ruby: 'Ruby',
    emerald: 'Emerald',
    fullSetPrice: 'Full Set Price',
    commissionBtn: 'Request This Set',
    commissionSuccess: '✓ Request received — we\'ll be in touch within 24 hours',
    priceNote: 'Prices in SAR · VAT included · Your representative confirms final details before delivery',
    viewerHint: 'DRAG TO ROTATE · SCROLL TO ZOOM',
    occasionPrefix: '',
    occasionSuffix: ' Set',
    loading: 'Loading…',
    errorMsg: 'This set has been sealed.',
    errorBack: '← Explore the current collection',
  },
  faq: {
